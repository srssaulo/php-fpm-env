...
/**
 * Strings for component 'auth_email', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   auth_email
...
$string['pluginname'] = 'Autoinscrição por email';
$string['privacy:metadata'] = 'O plug-in de autenticação de autoinscrição por email não armazena nenhum dado pessoal.';
