...
/**
 * Strings for component 'tool_behat', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   tool_behat
...
$string['nostepsdefinitions'] = 'Nenhuma definição de etapa correspondente a esse filtro';
...
$string['stepsdefinitionsfilters'] = 'Definição de Etapas';
