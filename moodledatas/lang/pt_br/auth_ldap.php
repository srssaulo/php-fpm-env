...
/**
 * Strings for component 'auth_ldap', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   auth_ldap
...
$string['privacy:metadata'] = 'O plugin de autenticação do servidor LDAP não armazena dados pessoais.';
